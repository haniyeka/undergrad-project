...
$(document).ready(function () {
    ...
    $('.Bookman').each(function () {
        if ($(this).val()) {
            $(this).parent('div').parent('div').parent('div.collapse').addClass('in');
        }
        else {

            $(this).parent('div').parent('div').parent('div.collapse').removeClass('in');
        }
    });
});
...
$('#submitbuttonEditSellerBook').click(function (e) {
    $('#validateError').text("");
    var button = $(this);
    e.preventDefault();
